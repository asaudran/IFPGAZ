...
with tab1.container():
    ...
    #ICI pour le foncitonnement en LOCAL
    #st.image("/Users/audran/Desktop/Data_MASSOL_GAZ_Russie/PAGE_MASSOL/capture1.png", caption='Vue de l ensemble', width=700)
    #ICI Pour le fonctionnement sur GitHUB Et aussi ici pour la fonction st.image
    st.image("capture1.png", caption='Vue de l ensemble', width=700)
